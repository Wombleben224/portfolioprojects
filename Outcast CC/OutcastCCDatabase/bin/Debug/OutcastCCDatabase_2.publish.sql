...
GO
/*
The column [dbo].[Members].[Bio] on table [dbo].[Members] must be added, but the column has no default value and does not allow NULL values. If the table contains data, the ALTER script will not work. To avoid this issue you must either: add a default value to the column, mark it as allowing NULL values, or enable the generation of smart-defaults as a deployment option.

The column [dbo].[Members].[Name] on table [dbo].[Members] must be added, but the column has no default value and does not allow NULL values. If the table contains data, the ALTER script will not work. To avoid this issue you must either: add a default value to the column, mark it as allowing NULL values, or enable the generation of smart-defaults as a deployment option.
*/
...
IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[Members])
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_Members] ([memberId], [Username], [Password], [ProfileImageType], [ProfileImageName])
        SELECT   [memberId],
                 [Username],
                 [Password],
                 [ProfileImageType],
